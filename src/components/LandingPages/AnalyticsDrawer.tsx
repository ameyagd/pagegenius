...
import { LineChartOutlined, BarChartOutlined, PieChartOutlined, FilterOutlined, EditOutlined, EyeOutlined } from '@ant-design/icons';
...
const AnalyticsDrawer: React.FC<AnalyticsDrawerProps> = ({
  ...
  return (
    <Drawer
      title={page ? `Analytics: ${page.title}` : "Page Analytics"}
      placement="right"
      width={800}
      onClose={onClose}
      open={visible}
